...
export const Item: React.FunctionComponent = () => {
  ...
  return (
    <>
      {isOpen && <Modal onClick={() => setIsOpen(false)}>HELOO</Modal>}
        ...
        <div className="flex flex-col rounded-sm border border-green p-8 s:flex-row s:justify-around">
          <div className="mb-12 w-full s:mb-0 s:w-[50%] ">
            ...
            <h3 className="text-2xl">
              ...
              odit, voluptatem placeat blanditiis eum ut. Lorem ipsum dolor sit,
              amet consectetur adipisicing elit. Vel non, quam unde quis
              consequatur numquam consequuntur aspernatur doloremque labore ad
              minus? Necessitatibus laboriosam dolorum odit, voluptatem placeat
